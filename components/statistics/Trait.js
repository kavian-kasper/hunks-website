  ...
  return (
    <>
      <dl
        ...
        className="mb-4 rounded-md w-36 md:w-56  text-gray-600 font-nunito font-bold mr-1 flex flex-wrap flex-col cursor-pointer"
        onClick={() =>
      ...
      >
        ...
        <img
          // h-16
          className="pixelated bg-primary mb-1 w-36 md:w-64 object-contain"
